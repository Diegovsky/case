...
class HashIdDictSerializerExtension(OpenApiSerializerExtension):
    target_class = HashIdDictSerializer
...
class HashIdDictSerializerFieldExtension(OpenApiSerializerFieldExtension):
    target_class = HashIdDictSerializer

    def map_serializer_field(self, auto_schema: AutoSchema, direction):
        return HashIdDictSerializerExtension(self.target).map_serializer(
