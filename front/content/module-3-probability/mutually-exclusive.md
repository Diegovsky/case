...
## The Addition Rule
When you want to find the probability of Event A **OR** Event B happening, you add their probabilities.

**Formula:**
$$P(A \cup B) = P(A) + P(B)$$

*(Note: If they are NOT mutually exclusive, you must subtract the intersection: $P(A) + P(B) - P(A \cap B)$)*
